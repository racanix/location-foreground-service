...
| **`alertTerminationEndpoint`** | <code>string</code>                                             | URL completa del endpoint para finalizar el viaje (incluye el alertId).                                                                                                                             |
...
| **`targetLocation`**           | <code><a href="#targetlocation">TargetLocation</a></code>       | Ubicación objetivo opcional. Al llegar dentro del rango se mostrará una alerta interactiva para confirmar la llegada. El servicio continuará ejecutándose hasta que el usuario confirme la llegada. |
